...
13. Create a branch for the next release:

    $ git checkout -b 1.5.0

14. Increment the version number in the pom file and commit it:

    $ git add pom.xml
    $ git commit -m "Incremented release number to 1.5.0"

15. Push the new branch to `origin`:

    $ git push origin 1.5.0

16. Announce the new release to the community and on social networks.
